...
(() => {
  ...
  E = document.createElement("iframe"), E.style.cssText = `
    ...
    top: 0;
    z-index: ${e2};
    left: 0;`, E.src = n.UI_APP_DEV, E.setAttribute("frameborder", "0"), E.addEventListener("load", () => c());
  ...
  t2.data && T[t2.data.name] && (T[t2.data.name](t2.data.data), t2.data.name === e.CLOSE_WIDGET && _());
});
var N = (e2) => {
...
export {
  ...
  y as addSuccessListener,
  m as addWidgetDestroyedListener,
  p as addWidgetInitListener,
